...
import { Layers, Fish, Navigation, ShieldAlert, Sparkles, Sliders, Activity, Clock, Compass, Waves, ArrowRight, Eye, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="h-[calc(100vh-6rem)] relative flex flex-col overflow-hidden rounded-2xl border border-[#24404A] bg-[#06131A]">
      ...
      <div className="flex-1 w-full h-full relative">
        ...
        <div className="absolute top-16 bottom-16 right-4 z-20 w-80 bg-[#081C24]/95 backdrop-blur-md border border-[#24404A] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          {/* Drawer Header Tabs */}
          <div className="flex border-b border-[#24404A] bg-[#06131A]">
            {[
      ...
      <div className="absolute bottom-4 left-4 z-20 flex items-center space-x-3 bg-[#081C24]/90 backdrop-blur-md p-2 rounded-xl border border-[#24404A] shadow-xl">
        <button
